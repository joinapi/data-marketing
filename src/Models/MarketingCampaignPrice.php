 ...
 */
class MarketingCampaignPrice extends Model
{
     ...
     * @var string
     */
    protected $table = 'marketing_campaign_price';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Marketing\ProductPriceRule', 'product_price_rule_id', 'product_price_rule_id');
    }
}
