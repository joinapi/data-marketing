 ...
 */
class TrackingCodeOrderReturn extends Model
{
     ...
     * @var string
     */
    protected $table = 'tracking_code_order_return';

    /**
     * @var array
     */
    protected $fillable = ['tracking_code_id', 'order_item_seq_id', 'is_billable', 'site_id', 'has_exported', 'affiliate_referred_time_stamp', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Marketing\ReturnHeader', 'return_id', 'return_id');
    }
