 ...
 * @property string $created_by_user_login_id
 ...
 * @property float $pipeline_amount
 * @property string $last_updated_stamp
 * @property string $last_updated_tx_stamp
 * @property string $created_stamp
 * @property string $created_tx_stamp
 * @property SalesForecastHistory[] $salesForecastHistories
 * @property UserLogin $userLoginByCreatedByUserLoginId
 ...
 * @property SalesForecast $salesForecastByParentSalesForecastId
...
class SalesForecast extends Model
{
     ...
     * @var string
     */
    protected $primaryKey = 'sales_forecast_id';
     ...
     * @var array
     */
    protected $fillable = ['parent_sales_forecast_id', 'organization_party_id', 'internal_party_id', 'custom_time_period_id', 'currency_uom_id', 'created_by_user_login_id', 'modified_by_user_login_id', 'quota_amount', 'forecast_amount', 'best_case_amount', 'closed_amount', 'percent_of_quota_forecast', 'percent_of_quota_closed', 'pipeline_amount', 'last_updated_stamp', 'last_updated_tx_stamp', 'created_stamp', 'created_tx_stamp'];
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Marketing\SalesForecastHistory', 'sales_forecast_id', 'sales_forecast_id');
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function userLoginByCreatedByUserLoginId()
    {
        return $this->belongsTo('Joinbiz\Data\Models\Marketing\UserLogin', 'created_by_user_login_id', 'user_login_id');
    }
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function salesForecastByParentSalesForecastId()
    {
        return $this->belongsTo('Joinbiz\Data\Models\Marketing\SalesForecast', 'parent_sales_forecast_id', 'sales_forecast_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Marketing\SalesForecastDetail', 'sales_forecast_id', 'sales_forecast_id');
    }
}
