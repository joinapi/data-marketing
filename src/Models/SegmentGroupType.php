 ...
 */
class SegmentGroupType extends Model
{
     ...
     * @var string
     */
    protected $table = 'segment_group_type';
     ...
     * @var string
     */
    protected $primaryKey = 'segment_group_type_id';
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Marketing\SegmentGroup', 'segment_group_type_id', 'segment_group_type_id');
    }
}
